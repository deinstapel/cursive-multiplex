...
fn main() {
    ...
    let right3 = mux.add_vertical_id(TextView::new("right 3"), right1).expect("right 3 failed");
    ...
    let _left3 = mux.add_vertical_id(TextView::new("left 3"), left1).expect("left 3 failed");
